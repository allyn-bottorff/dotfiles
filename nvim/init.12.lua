...
vim.pack.add({
  ...
  { src = "https://github.com/sebdah/vim-delve" },      -- Go debugging
  { src = "https://github.com/tpope/vim-fugitive" },    -- Git integration (mostly just for Blame)
  { src = "https://github.com/junegunn/fzf.vim" },      -- fuzzy finding file/buffer stuff
  { src = "https://github.com/junegunn/fzf" },          -- fuzzy finding file/buffer stuff
  { src = "https://github.com/numToStr/Comment.nvim" }, -- 'gc' to auto comment
